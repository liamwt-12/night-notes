  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <a href="https://apps.apple.com/gb/app/night-notes/id6760349512" className="hero-cta">
      ...
      <section className="final">
        ...
        <div className="final-buttons">
          <a href="https://apps.apple.com/gb/app/night-notes/id6760349512" className="final-dl">
